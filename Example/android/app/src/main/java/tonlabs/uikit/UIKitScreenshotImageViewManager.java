...
@ReactModule(name = UIKitScreenshotImageView.REACT_CLASS)
public class UIKitScreenshotImageViewManager extends ViewGroupManager<UIKitScreenshotImageView> {
    ...
    public String getName() {
        return UIKitScreenshotImageView.REACT_CLASS;
    }

    @NonNull
    @Override
    protected UIKitScreenshotImageView createViewInstance(@NonNull ThemedReactContext reactContext) {
        return new UIKitScreenshotImageView(reactContext);
    }
    ...
    @Override
    public void receiveCommand(@NonNull @NotNull UIKitScreenshotImageView root,
                               int commandId,
    ...
    public @Nullable Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.of(
            UIKitScreenshotImageView.EVENT_COMMAND_FINISHED,
            MapBuilder.of(
                    "registrationName",
                    UIKitScreenshotImageView.EVENT_COMMAND_FINISHED
            )
