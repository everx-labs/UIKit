...
import tonlabs.uikit.TraceLog;
import tonlabs.uikit.TraceNativeViewHierarchyManager;


public class TraceUIViewOperationQueue extends UIViewOperationQueue {
    ...
    public int printableDoFrames = 0;
    ...
    public TraceUIViewOperationQueue(
        ...
        ((TraceNativeViewHierarchyManager) nativeViewHierarchyManager).mTraceUIViewOperationQueue = this;
                    ...
                    new Runnable() {
                        ...
                        public void run() {
                            SystraceMessage.beginSection(Systrace.TRACE_TAG_REACT_JAVA_BRIDGE, "DispatchUI")
                                    .arg("BatchId", batchId)
                                    .flush();
                            TraceLog.log("dispatchViewUpdates runOperations");
                            try {
                ...
                UiThreadUtil.runOnUiThread(
                        new GuardedRunnable(mReactApplicationContext) {
                            ...
                            public void runGuarded() {
                                mFlushPendingBatchesCaller = "UiThreadUtil.runOnUiThread flushPendingBatches";
                                flushPendingBatches();
                            }
                        });
            }
    ...
    /* package */ void pauseFrameCallback() {
        ...
        mFlushPendingBatchesCaller = "pauseFrameCallback flushPendingBatches";
        flushPendingBatches();
    }

    String mFlushPendingBatchesCaller = "none";
    ...
    private void flushPendingBatches() {
        ...
        TraceLog.log("flushPendingBatches " + mFlushPendingBatchesCaller + " " + runnables.size());

        final long batchedExecutionStartTime = SystemClock.uptimeMillis();
        for (Runnable runnable : runnables) {
            TraceLog.log("flushPendingBatches runnable");
            runnable.run();
        }
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long frameTimeNanos) {
            ...
            mFlushPendingBatchesCaller = "DispatchUIFrameCallback doFrameGuarded";
//            TraceLog.log("DispatchUIFrameCallback doFrameGuarded");
            if (printableDoFrames > 0) {
