...
import tonlabs.uikit.TraceUIImplementation;

class TraceUIImplementationProvider extends UIImplementationProvider {
    @Override
    UIImplementation createUIImplementation(
        ...
        TraceLog.log("TraceUIImplementationProvider");
        return new TraceUIImplementation(
                reactContext,
                viewManagerRegistry,
                eventDispatcher,
...
public class TraceUIManagerModule extends UIManagerModule {
    public TraceUIManagerModule(
            ReactApplicationContext reactContext,
        ...
        super(
                reactContext,
                viewManagersList,
                new TraceUIImplementationProvider(),
                minTimeLeftInFrameForNonBatchedOperationMs);
    }
...
//        TraceLog.log("TraceUIManagerModule createView " + className);
...
//        TraceLog.log("TraceUIManagerModule updateView " + className);
//        long t = System.currentTimeMillis();
