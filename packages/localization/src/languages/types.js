...
export type UILocalizedData = {|
    ...
    +Browser: {|
        ...
        |},
        +DateTimeInput: {|
            +DoYouWantChooseDate: string,
            +DoYouWantChooseTime: string,
            +DoYouWantChooseDateTime: string,
            +ChooseDate: string,
            +ChooseTime: string,
            +ChooseDateTime: string,
            +YouHaveChosenTheDate: string,
            +YouHaveChosenTheTime: string,
            +YouHaveChosenTheDateTime: string,
        |},
        +Menu: {|
            +More: string,
        |},
