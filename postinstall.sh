...
sed -i '' -e '8s/.*/    mavenCentral()/' ./node_modules/react-native-pager-view/android/build.gradle
sed -i '' -e '39s/.*/    mavenCentral()/' ./node_modules/react-native-pager-view/android/build.gradle
